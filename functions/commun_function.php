...
function get_brands()
{
  ...
  while ($row_data = mysqli_fetch_assoc($result_brands)) {
    ...
    echo "<li class='nav-item'>
                <a href='index.php?brand_id={$brand_id}' class='nav-link text-light' style='font-size:85%;'>{$brand_title}</a>
                </li>";
  }
}
...
function get_categories()
{
  ...
  while ($row_data = mysqli_fetch_assoc($result_categories)) {
    ...
    echo "<li class='nav-item'>
            <a href='index.php?category_id={$category_id}' class='nav-link text-light' style='font-size: 85%;'>{$category_title}</a>
            </li>";
  }
}
  ...
  if (isset($_GET['search_data_product'])) {
    ...
    if ($num_of_rows == 0) {
      ...
      while ($row = mysqli_fetch_assoc($result_query)) {
        ...
        $product_image3 = $row['product_image3'];
        $product_price = $row['product_price'];
          echo "<div class='col-md-4 mb-2 rounded-10'>
                <div class='card'>
                  <img src='./admin_area/product_images/$product_image1' class='card-img-top' alt='$product_title'>
                    <div class='card-body'>
                    <h6 class='btn-outline-secondary'>Rs:-  $product_price/-</h6>
